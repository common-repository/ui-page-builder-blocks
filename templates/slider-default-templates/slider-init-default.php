...
<script type='text/javascript'>
    jQuery(document).ready(function   ($) {
        ...
        if($('.uipbb-slider-active').length == 1){
            var jssor_slider = new $JssorSlider$('<?php echo "uipbb-slider-container-".$post_id; ?>', jssor_options);
        ...
        function uipbb_responsive_ScaleSlider() {
            //console.log($('#<?php echo "uipbb-slider-container-".$post_id; ?>'));
            var parentWidth = $('#<?php echo "uipbb-slider-container-".$post_id; ?>').parent().width();
            if (parentWidth) {
